...
declare const copyCode: (options: CopyCodeOptions | false) => PluginConfig<CopyCodeOptions>;

export { CopyCodeLocaleConfig, CopyCodeLocaleData, CopyCodeOptions, copyCode, copyCodePlugin, copyCodePlugin as default };
