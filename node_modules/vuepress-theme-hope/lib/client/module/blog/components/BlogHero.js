...
export default defineComponent({
    ...
    setup() {
        ...
        const heroImageStyle = computed(() => {
            const defaultStyle = {
                maxHeight: "180px",
                margin: frontmatter.value.showTitle === false
                    ? "6rem auto 1.5rem"
                    : "1rem auto",
            };
            return {
        ...
        return () => frontmatter.value.hero !== false
            ? h("div", {
                ...
                h(DropTransition, { delay: 0.04 }, () => heroImage.value
                    ? h("img", {
                        class: "hero-logo",
                    ...
                    : null),
                h(DropTransition, { delay: 0.08 }, () => frontmatter.value.showTitle !== false
                    ? h("h1", frontmatter.value.heroText || title.value)
                    : null),
                h(DropTransition, { delay: 0.12 }, () => frontmatter.value.tagline
                    ? h("p", {
                        class: "description",
