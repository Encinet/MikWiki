...
export const LockIcon = () => h(IconBase, { name: "lock" }, () => h("path", {
...
export const StickyIcon = () => h(IconBase, { name: "sticky" }, () => [
    h("path", {
        d: "M989.922 444.341 580.15 34.909H119.411l870.511 870.597V444.34z",
    }),
    h("path", {
        class: "sticky-text",
...
export const BookIcon = () => h(IconBase, { name: "book" }, () => h("path", {
...
export const LinkIcon = () => h(IconBase, { name: "link" }, () => h("path", {
...
export const ProjectIcon = () => h(IconBase, { name: "project" }, () => h("path", {
...
export const FriendIcon = () => h(IconBase, { name: "friend" }, () => h("path", {
