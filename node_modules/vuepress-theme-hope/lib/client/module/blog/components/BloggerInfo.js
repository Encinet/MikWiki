...
import { useNavigate, useThemeData, useThemeLocaleData, } from "@theme-hope/composables";
import { useArticles, useBlogOptions, useCategoryMap, useTagMap, useTimelines, } from "@theme-hope/module/blog/composables";
        ...
        return () => h("div", {
            ...
            h("div", {
                ...
                bloggerAvatar.value
                    ...
                    : null,
                bloggerName.value
                    ? h("div", { class: "name", property: "name" }, bloggerName.value)
                    : null,
                blogOptions.value.description
                    ? h("div", { class: "description" }, blogOptions.value.description)
                    : null,
                intro.value
