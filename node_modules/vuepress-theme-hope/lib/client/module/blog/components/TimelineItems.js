...
import { useBlogOptions, useTimelines, } from "@theme-hope/module/blog/composables";
...
export default defineComponent({
    ...
    setup() {
        ...
        return () => h("div", { class: "timeline-wrapper" }, h("ul", { class: "timeline-content" }, [
            ...
            ...timelines.value.config.map(({ year, items }, index) => h(DropTransition, { delay: 0.08 * (index + 1) }, () => h("li", [
                h("h3", { id: year, class: "year" }, h("span", year)),
                h("ul", { class: "year-wrapper" }, items.map(({ date, info, path }) => h("li", [
