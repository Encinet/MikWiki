...
import { ArticleIcon, CategoryIcon, TagIcon, TimelineIcon, } from "@theme-hope/module/blog/components/icons";
import { useNavigate, useThemeLocaleData } from "@theme-hope/composables";
import { useArticles, useCategoryMap, useStars, useTagMap, } from "@theme-hope/module/blog/composables";
...
export default defineComponent({
    ...
    setup() {
        ...
        return () => h("div", { class: "blog-info-list" }, [
            h("div", { class: "switch-wrapper" }, buttons.map(([key, icon]) => h("button", {
                class: "switch-button",
                onClick: () => {
                    active.value = key;
                },
            ...
            active.value === "article"
                ? h(DropTransition, () => [
                    h("div", { class: "sticky-article-wrapper" }, [
                        ...
                        h("hr"),
                        h("ul", { class: "sticky-article-list" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { delay: 0.08 * (index + 1) }, () => h("li", {
