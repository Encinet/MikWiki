...
exports.resolveEncrypt = exports.handleWebpackOptions = void 0;
const utils_1 = require("./utils");
const bcryptjs_1 = require("bcryptjs");
const handleWebpackOptions = (app) => {
    ...
    if (bundler.endsWith("webpack")) {
        ...
        webpackBundlerConfig.configureWebpack = (config, isServer, isBuild) => {
            ...
            return (configureWebpack?.(config, isServer, isBuild
            // FIXME: Upchain type issues
            ) || {});
        };
    }
};
exports.handleWebpackOptions = handleWebpackOptions;
