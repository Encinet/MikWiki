import { App, LocaleData, PageFrontmatter, ThemeConfig, LocaleConfig, Page } from '@vuepress/core';
 ...
 */
declare const addViteOptimizeDeps: (app: App, module: string | string[]) => void;

declare const noopModule = "@mr-hope/vuepress-shared/lib/client/noopModule.js";
 ...
 */
declare const useCustomDevServer: (app: App, path: string, getResponse: (request?: IncomingMessage | undefined) => Promise<string | Buffer>, errMsg?: string) => void;
...
declare const lang2Path: (lang?: string) => string;
/**
 ...
 */
declare const getLocales: <T>(app: App, defaultLocalesConfig: ConvertLocaleConfig<T>, userLocalesConfig?: LocaleConfig<T>) => ConvertLocaleConfig<T>;
 ...
 */
declare const useGitPlugin: (app: App, options: GitPluginOptions) => void;
/**
...
} & Partial<GitPluginPageData>>, options: DateOptions) => void;
...
declare function mergeViteConfig(a: Record<string, any>, b: Record<string, any>, isRoot?: boolean): Record<string, any>;

export { Author, AuthorInfo, BasePageFrontMatter, BaseThemeConfig, ConvertLocaleConfig, DateDetail, DateInfo, DateOptions, HopeLang, Logger, addViteOptimizeDeps, capitalize, checkLang, compareDate, deepAssign, deepAssignReverse, encodeCDATA, encodeXML, getAuthor, getCategory, getDate, getLocalePaths, getLocales, getRootLang, getRootLangPath, getTag, injectLocalizedDate, isAbsoluteUrl, isUrl, lang2Path, mergeViteConfig, noopModule, path2Lang, removeGitPlugin, showLangError, strictCapitalize, timeTransformer, useCustomDevServer, useGitPlugin };
